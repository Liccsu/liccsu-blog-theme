...
| [完整文档](https://5ee.net/docs/halo-theme-sky-blog-1/jianjie) | 原项目配置指南和使用说明 |
...
3. 从本仓库 Releases 下载主题包并安装

**方式 2：手动安装**

1. 从 [Releases](https://github.com/Liccsu/liccsu-blog-theme/releases) 下载最新版本
...
1. **GitHub Issues**：[提交 Issue](https://github.com/Liccsu/liccsu-blog-theme/issues)
2. **加入社群**：与其他用户交流
