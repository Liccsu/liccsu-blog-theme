...
document.addEventListener("alpine:init", () => {
  ...
  Alpine.data("postLike", () => ({
    ...
    checkLikeStatus() {
      ...
      const upvotedNames = JSON.parse(localStorage.getItem("halo.upvoted.post.names") || "[]");
...
(function () {
  ...
  const pageManager = {
    ...
    initCodeCopy() {
      ...
      codeBlocks.forEach((codeElement) => {
        ...
        copyButton.className =
          "absolute top-2 right-2 px-3 py-1 bg-base-200 hover:bg-base-300 rounded text-sm transition-colors";
    ...
    initWordCount() {
      ...
      const readingTimeMinutes = Math.ceil(chineseCount / 300 + englishCount / 200);
