...
// 导入 TOC 公共工具函数
import { buildDynamicTocTree, createDynamicTocHTML, smoothScrollToHeading } from "../../common/js/toc-utils.js";
...
function initTOC() {
  ...
  const headings = Array.from(allHeadings).filter((h) => +h.tagName[1] <= minLevel + 2);
